...
1. You must use open a new vault using the `wiki` directory within `hyper-productivity/docs`. New notes would then show up as `hyper-productivity/docs/wiki/note.md` (no nesting/sub-directories for notes).
