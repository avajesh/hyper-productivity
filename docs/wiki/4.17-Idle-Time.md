...
- **Web** — Idle detection on the web typically **requires the Hyper Productivity Chrome extension**. Without it, the app cannot detect system idle time in the browser, so the feature may be unavailable or limited.
...
- **Web** — Idle detection usually **requires the Hyper Productivity Chrome extension**; without it, the feature may not be available.
