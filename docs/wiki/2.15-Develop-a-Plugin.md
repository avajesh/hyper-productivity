...
How to create and test a custom plugin for Hyper Productivity.
...
**[docs/plugin-development.md](https://github.com/avajesh/hyper-productivity/blob/master/docs/plugin-development.md)**
