...
Hyper Productivity includes built-in themes and can install local CSS theme files. Themes change presentation only; they do not change or sync task data.
...
- **Ready-made themes:** [hyper-productivity-themes (dist)](https://github.com/avajesh/hyper-productivity-themes/tree/main/dist) — download a `.css` file and install it from **Settings → General → Theme**.
- **Create your own:** [hyper-productivity-themes](https://github.com/avajesh/hyper-productivity-themes) — repo with info and examples for building custom themes.
