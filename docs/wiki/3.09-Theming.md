...
- **Ready-made themes:** [super-productivity-themes (dist)](https://github.com/avajesh/hyper-productivity-themes/tree/main/dist) — download a `.css` file and install it from **Settings → General → Theme**.
- **Create your own:** [super-productivity-themes](https://github.com/avajesh/hyper-productivity-themes) — repo with info and examples for building custom themes.
