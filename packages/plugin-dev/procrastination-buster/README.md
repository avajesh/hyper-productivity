...
A Hyper Productivity plugin that helps identify procrastination blockers and provides tailored strategies to overcome them.
...
### Use in Hyper Productivity

1. Run `npm run build`
2. Upload the generated `dist/plugin.zip` in Hyper Productivity
...
1. **plugin.ts** - Backend logic that communicates with Hyper Productivity
