...
<p align="center">
  :globe_with_meridians: <a href="https://app.super-productivity.com">Open Web App</a> or :computer: <a href="https://github.com/avajesh/hyper-productivity/wiki/2.01-Downloads-and-Install">Download</a>
</p>
...
<p align="center">
  ...
  &nbsp;
  <a href="https://github.com/avajesh/hyper-productivity/discussions"><img alt="GitHub Discussions" src="https://img.shields.io/badge/Community-Discussions-blue?style=flat-square&logo=github"/></a>
</p>
...
<p align="center">
  ...
  <a href='http://apps.obtainium.imranr.dev/redirect.html?r=obtainium://add/https://github.com/avajesh/hyper-productivity/releases'><img src='https://raw.githubusercontent.com/ImranR98/Obtainium/main/assets/graphics/badge_obtainium.png' alt='Obtanium Badge' height="30"/></a>
...
<p align="center">
  <strong>For all current downloads, package links, and platform-specific notes:
    <a href="https://github.com/avajesh/hyper-productivity/wiki/2.01-Downloads-and-Install" target="_blank">
      check the wiki
    </a>
  </strong><br/>
  <a href="https://github.com/avajesh/hyper-productivity/wiki/2.01-Downloads-and-Install" target="_blank">
...
- Back up and synchronize your data across multiple devices with **SuperSync**, **Dropbox** and **WebDAV** support. SuperSync is our own end-to-end encrypted sync service, which you can also [host yourself](https://github.com/avajesh/hyper-productivity/tree/master/packages/super-sync-server).
...
> [!NOTE]
> The web version has some limitations: See the **[Web App vs Desktop comparison](https://github.com/avajesh/hyper-productivity/wiki/3.05-Web-App-vs-Desktop)** for more details.
...
<div style="display: flex; gap: 30px; align-items: flex-start;">
  ...
  <div style="flex: 1;">
    ...
    <p><strong>Starting Point in Wiki:</strong><br>
      <a href="https://github.com/avajesh/hyper-productivity/wiki/1.01-First-Steps">First steps</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/3.00-Reference">Reference</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/2.00-How_To">How-To</a>
    </p>
    <p><strong>Productivity Tips:</strong><br>
      <a href="https://github.com/avajesh/hyper-productivity/wiki/3.03-Keyboard-Shortcuts">Keyboard Shortcuts</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/3.04-Short-Syntax">Short Syntax</a>
    </p>
    <p><strong>Need Help?</strong><br>
      <a href="https://github.com/avajesh/hyper-productivity/discussions">Visit the discussions page</a>
    </p>
  ...
  <div style="flex: 1;">
    ...
    <p>Here are some other topics covered in the
      <a href="https://github.com/avajesh/hyper-productivity/wiki">official wiki</a>:
    </p>
    <p><strong>Development:</strong><br>
      <a href="https://github.com/avajesh/hyper-productivity/wiki/2.11-Run-the-Development-Server">Run dev server</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/2.12-Package-the-App">Package the app</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/2.14-Build-for-Android">Build for Android</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/2.13-Run-with-Docker">Run with Docker</a>
    </p>
    <p><strong>Data Management:</strong><br>
      <a href="https://github.com/avajesh/hyper-productivity/wiki/4.23-Managing-Your-Data">User Data</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/3.07-Issue-Integration-Comparison">Issue Providers</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/3.08-Sync-Integration-Comparison">Sync Providers</a>
    </p>
    <p><strong>Customization:</strong><br>
      <a href="https://github.com/avajesh/hyper-productivity/wiki/2.15-Develop-a-Plugin">Plugins</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/3.09-Theming">Themes</a>
    </p>
    <p><strong>APIs:</strong><br>
      <a href="https://github.com/avajesh/hyper-productivity/wiki/3.01-API#1-sync-server-rest-api">Sync Server</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/3.01-API#2-plugin-api">Plugins</a> •
      <a href="https://github.com/avajesh/hyper-productivity/wiki/3.01-API#3-local-rest-api">REST</a>
    </p>
  </div>
</div>
...
2. **Provide a Pull Request:** Here is a list of [the most popular community requests](https://github.com/avajesh/hyper-productivity/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-%2B1-desc) and here some info on **[how to run the development build](https://github.com/avajesh/hyper-productivity/wiki/2.11-Run-the-Development-Server)** (wiki).
...
3. **[Answer questions](https://github.com/avajesh/hyper-productivity/discussions)**: You know the answer to another user's problem? Share your knowledge!

4. **[Provide your opinion](https://github.com/avajesh/hyper-productivity/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-%2B1-desc+label%3A%22community+feedback+wanted%22):** Some community suggestions are controversial. Your input might be helpful and if it is just an up- or down-vote.

5. **[Provide a more refined UI spec for existing feature requests](https://github.com/avajesh/hyper-productivity/issues?q=is%3Aissue+is%3Aopen+label%3A%22needs+concept+and%2For+ui+spec%22)**

6. **[Report bugs](https://github.com/avajesh/hyper-productivity/issues/new)**

7. **[Make a feature or improvement request](https://github.com/avajesh/hyper-productivity/issues/new)**: Something can be done better? Something essential missing? Let us know!

8. **[Translations](https://github.com/avajesh/hyper-productivity/tree/master/src/assets/i18n), Icons, etc.**: You don't have to be a programmer to help; **[learn how to contribute translations](https://github.com/avajesh/hyper-productivity/wiki/2.18-Contribute-Translations)**!

[//]: # '[![inlang status badge](https://badge.inlang.com/?url=github.com/avajesh/hyper-productivity)](https://fink.inlang.com/github.com/avajesh/hyper-productivity?ref=badge)'
[//]: #
...
10. **Create [custom plugins](https://github.com/avajesh/hyper-productivity/wiki/2.15-Develop-a-Plugin)** or **[custom themes](https://github.com/avajesh/hyper-productivity/wiki/3.09-Theming)**
...
There are two wikis: the official one hosted in by GitHub and the autonomously generated variant using [DeepWiki.com](https://deepwiki.com/avajesh/hyper-productivity). The manually curated version is a more stable and approachable resource designed to help you understand the app from a more human-focused perspective whereas DeepWiki is optimized for explaining the code itself with little regard for context beyond that.
...
<div style="display: flex; gap: 10px; align-items: flex-start;">
  ...
  <div style="flex: 1;">
    ...
    <p>
      ...
      demonstrated in
      <a href="https://github.com/avajesh/hyper-productivity/commit/7a51d4b06e414fdcc48e4999197a93eee9cd09da">this commit</a>.
    </p>
    <p>
  ...
  <div style="flex: 1;">
    ...
    <p>
      ...
      <a href="https://deepwiki.com/avajesh/hyper-productivity">
