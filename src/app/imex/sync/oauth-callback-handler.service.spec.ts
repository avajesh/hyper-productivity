...
describe('OAuthCallbackHandlerService', () => {
  ...
  describe('routed URL', () => {
    ...
    it('should deliver an OAuth callback routed after setup', () => {
      ...
      pendingUrl$.next('com.hyperproductivity.app://oauth-callback?code=ABC123');
    ...
    it('should not retain a routed URL for a later subscriber', () => {
      pendingCapacitorOAuthUrl$.next(
        'com.hyperproductivity.app://oauth-callback?code=NOT_RETAINED',
      );
  ...
  describe('_parseOAuthCallback', () => {
    it('should extract auth code from valid URL', () => {
      const url = 'com.hyperproductivity.app://oauth-callback?code=ABC123';
    ...
    it('should extract error from callback URL', () => {
      const url =
        'com.hyperproductivity.app://oauth-callback?error=access_denied&error_description=User%20denied%20access';
      const result = service['_parseOAuthCallback'](url);
    ...
    it('should handle URL without code or error', () => {
      const url = 'com.hyperproductivity.app://oauth-callback';
      const result = service['_parseOAuthCallback'](url);
    ...
    it('should decode URL-encoded parameters', () => {
      const url =
        'com.hyperproductivity.app://oauth-callback?error_description=Access%20was%20denied';
      const result = service['_parseOAuthCallback'](url);
