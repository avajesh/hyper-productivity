...
describe('buildIdbOpenErrorMessage', () => {
  ...
  describe('downgrade barrier (#9187)', () => {
    ...
    // appId `com.hyperproductivity.app`, which is what a careless grep finds.
    //
    ...
    it('points Flatpak users at flatpak update with the real Flathub id', () => {
      ...
      expect(msg).toContain('flatpak update com.hyperproductivity.Hyper Productivity');
      expect(msg).not.toContain('com.hyperproductivity.app');
